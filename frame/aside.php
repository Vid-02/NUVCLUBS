...
<aside>
	<div id="sidebar">
		...
		<ul>
			<a href="#event"><li><b>Recent Events</b></li></a>
			<a href="../imageGallery/imageGallery.php"><li><b>Image Gallery</b></li></a>
			
			<input type="text" onkeyup="showHint()" id="mytext" placeholder="Search Member">
			<i class="fa fa-search" onclick="showHint()"></i>
			<h4 id="txtHint"></h4>

			<li class="jn-club" style="background-color: #BD181F;">Join Another Club
