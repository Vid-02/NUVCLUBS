...
<div id="menu">
	...
	<div id="logo">
		<a href="../homepage/homepage.php"><img src="../img/Title.png"></a>
	</div>
		<ul class="main-nav">
			...
			<!-- <li><a onclick="showNotif()" href="#"><i class="fa fa-bell" aria-hidden="true" style="color:#ffffff"></i></a></li>
			...
			<li><a href="http://localhost/NUVCLUBS/NUVCHATS/login.php" id="inbxmsg" >Message
...
<?php
	...
	?>
			...
			<li class="logout1"><a href="../logout.php">Logout&nbsp;<i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
			<!--&nbsp;&nbsp;-->
