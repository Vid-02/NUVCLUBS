...
<div id="msg_box">
	...
	<div id="msg_head" onclick="toggleMsg()">Name<i style="margin-left:63%; color: rgb(242, 242, 242);background-color:#000" class="fa fa-window-close fa-lg" aria-hidden="true" onclick="close_msg()"></i></div>
