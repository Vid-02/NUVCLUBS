...
<div class="container">
		...
		<h5 style="background-color:#BD181F"><i class="fa fa-flag" aria-hidden="true"></i>&nbsp;Notice</h5>
...
<div class="event_wrap">
	<h5 style="background-color:#BD181F"><i class="fa fa fa-list" aria-hidden="true"></i><a name="event"></a>&nbsp;Join Events</h5>
...
?>
	...
	<div class="evnt_bottom" style="background-color:#BD181F"></div>
	<div style="float: right; margin-right: 5px; margin-top: 10px;">
		<button class="btn" id="viewDetail" style="background-color:#BD181F">View Details</button>
	</div>
</div>
